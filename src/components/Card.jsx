      ...
      <div className={`card card-confession ${isVisible ? 'visible' : ''}`}>
        <div className="card-content">
          <div className="confession-content">
            ...
            {data.extraContent &&
              data.extraContent.map((paragraph, index) => (
                <p key={`extra-${index}`} className="card-paragraph">
                  {paragraph}
                </p>
              ))}
            ...
            {data.finalWords &&
              data.finalWords.map((paragraph, index) => (
                <p key={`final-${index}`} className="card-paragraph">
                  {paragraph}
                </p>
              ))}
          ...
          <div className="poem-content">
            <div className="poem-box">
              {data.lines.map((line, index) => (
                <p key={index} className="hindi-line">
                  {line}
                </p>
              ))}
